defmodule FpTriviaWeb.QuestionLiveTest do
  use FpTriviaWeb.ConnCase

  import Phoenix.LiveViewTest
  import FpTrivia.TriviaFixtures

  @create_attrs %{category: "some category", question: "some question", rank: 42}
